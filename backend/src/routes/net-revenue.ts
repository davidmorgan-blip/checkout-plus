  ...
  try {
    ...
    let opportunitiesQuery = `
      SELECT
        ...
        o.opportunity_record_type as opportunityRecordType,
  ...
  try {
    ...
    for (const opportunity of opportunities) {
      ...
      const merchantData: any = {
        ...
        'Opportunity Record Type': opportunity.opportunityRecordType || '',
  ...
  try {
    ...
    for (const opportunity of opportunities) {
      ...
      merchantData.push({
        ...
        opportunityRecordType: opportunity.opportunity_record_type || '',
        pricingModel: opportunity.pricing_model,
        labelsPaidBy: opportunity.labels_paid_by,
        merchantSegment: opportunity.merchant_segment || '',
        originalNetAcv,
        startingAcv,
        originalEndingAcv,
        projectedEndingAcv,
